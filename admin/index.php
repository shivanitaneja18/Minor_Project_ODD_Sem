...
<!--head background-->
	...
	<!--text: faceback -->
	<div style="position:absolute;left:36%; top:3.3%; font-size:45; font-weight:900; color:#FFFFFF; font-weight:bold; box-shadow:0px -10px 20px 1px rgb(0,0,0);"> <font face="myFbFont"> Fakebook </font> </div>
	<!--body background-->
    ...
    <div style="position:absolute; left:10%; top:15%;"> <img src="img" width="500" height="500"> </div> 
